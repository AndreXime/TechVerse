			...
			<main>
				<section className="text-center my-40 content-section animate-fadeInUp">
					...
					<p className="max-w-3xl mx-auto text-lg">
						Bem-vindo ao TechVerse, seu portal para o futuro da tecnologia. Exploramos a fronteira entre o cyberpunk,
						inovações em hardware, e a cultura digital que molda o nosso mundo.
					</p>
				</section>
...
function FeaturedPost({ category, title, description, tags, imageUrl, slug }: PostType) {
	return (
		<>
			<div className="border-l-2 border-cyan-500 pl-6 break-words">
